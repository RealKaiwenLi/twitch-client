...
public class MySQLDBUtil {
    private static final String INSTANCE = "jupyter.cuc8pnxufoi1.us-east-2.rds.amazonaws.com";
    private static final String PORT_NUM = "3306";
    private static final String DB_NAME = "kaiwen";
